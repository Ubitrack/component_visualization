...
==============
This is the Ubitrack component_visualization submodule.

Description
----------
The component_visualization contains components for visualization and provides the utGLFWConsole app.
...
If you handle multiple dependencies in your project is better to add a *conanfile.txt*
    ...
    [requires]
    ubitrack_component_visualization/1.3.0@ubitrack/stable
...
## Upload
    ...
    $ conan upload -r ubitrack ubitrack_component_visualization/1.3.0@ubitrack/stable
